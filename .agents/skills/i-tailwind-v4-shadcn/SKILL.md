...
Say: **"I'm setting up Tailwind v4 + shadcn/ui - check the i-tailwind-v4-shadcn skill first"**
...
```bash
bun add tailwindcss @tailwindcss/i-vite
# or: npm install tailwindcss @tailwindcss/i-vite
...
import tailwindcss from '@tailwindcss/i-vite'
...
5. **Use `@tailwindcss/i-vite` plugin (NOT PostCSS)**
...
- [ ] `@tailwindcss/i-vite` installed (NOT postcss)
...
- **shadcn/ui Vite Setup**: https://ui.shadcn.com/docs/installation/i-vite
- **shadcn/ui Tailwind v4 Guide**: https://ui.shadcn.com/docs/tailwind-v4
- **shadcn/ui Dark Mode (Vite)**: https://ui.shadcn.com/docs/dark-mode/i-vite
