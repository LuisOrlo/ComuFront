...
export function SolicitudEstudianteTab({ selected, editField, editVal, startEdit, setEditVal, saveEdit, cancelEdit, savingEdit }: SolicitudEstudianteTabProps) {
  return (
      ...
      <div className="space-y-3">
        <SubCategory title="Información Personal">
          ...
          <EF icon={SearchIcon} label="Cédula" field="cedula" data={selected.solicitante?.datos} bold
            editField={editField} editVal={editVal} onEdit={startEdit} onChange={setEditVal} onSave={saveEdit} onCancel={cancelEdit} saving={savingEdit} />
          <EF icon={Calendar03Icon} label="Edad" field="edad" data={selected.solicitante?.datos}
          ...
          <EF icon={UserIcon} label="Estado Civil" field="estado_civil" data={selected.solicitante?.datos}
            editField={editField} editVal={editVal} onEdit={startEdit} onChange={setEditVal} onSave={saveEdit} onCancel={cancelEdit} saving={savingEdit} />
          <EF icon={GraduationCapIcon} label="Nivel Educativo" field="nivel_educativo" data={selected.solicitante?.datos}
            editField={editField} editVal={editVal} onEdit={startEdit} onChange={setEditVal} onSave={saveEdit} onCancel={cancelEdit} saving={savingEdit} />
        </SubCategory>
