...
import { ArrowLeft, UserPlus, Tag, X } from "lucide-react"
          ...
          <div className="rounded-xl bg-gradient-to-br from-gray-50 to-gray-100/80 p-5 space-y-3 border" style={{ borderColor: COLORS.BORDER_SUBTLE }}>
            ...
            {!showDescuento ? (
              <button
                ...
                className="mt-1 inline-flex items-center gap-1.5 self-start rounded-lg border border-dashed border-orange-300 bg-orange-50/60 px-3 py-1.5 text-xs font-semibold text-orange-700 transition hover:border-orange-400 hover:bg-orange-100/70"
              >
                <Tag size={13} />
                <span>+ Aplicar descuento a la reserva</span>
              </button>
            ) : (
              <div className="mt-3 rounded-xl border border-orange-200/80 bg-orange-50/40 p-4 space-y-3">
                <div className="flex items-center justify-between border-b border-orange-100 pb-2.5">
                  <div className="flex items-center gap-2">
                    <span className="flex h-6 w-6 items-center justify-center rounded-md bg-orange-100 text-orange-700 shadow-xs">
                      <Tag size={13} />
                    </span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 pt-0.5">
                  ...
                  <div className="sm:col-span-5 space-y-1">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="h-9 w-full rounded-lg border border-slate-200 bg-white pl-7 pr-3 text-xs font-semibold text-slate-800 outline-none transition hover:border-slate-300 focus:border-orange-500 focus:ring-2 focus:ring-orange-100"
                      />
                    </div>
                  </div>
                  ...
                  <div className="sm:col-span-7 space-y-1">
                    ...
                    <input
                      ...
                      className="h-9 w-full rounded-lg border border-slate-200 bg-white px-3 text-xs text-slate-800 outline-none transition hover:border-slate-300 focus:border-orange-500 focus:ring-2 focus:ring-orange-100"
                    />
                  </div>
                </div>
              </div>
