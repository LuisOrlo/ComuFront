              ...
              <div className="space-y-1.5">
                  ...
                  {!showDescuento ? (
                    <button
                      ...
                      className="mt-1 inline-flex items-center gap-1.5 self-start rounded-lg border border-dashed border-blue-300 bg-blue-50/60 px-3 py-1.5 text-xs font-semibold text-blue-700 transition hover:border-blue-400 hover:bg-blue-100/70"
                    >
                      <Tag size={13} />
                      <span>+ Aplicar descuento al trabajo</span>
                    </button>
                  ) : (
                    <div className="mt-3 rounded-xl border border-blue-200/80 bg-blue-50/40 p-4 space-y-3">
                      <div className="flex items-center justify-between border-b border-blue-100 pb-2.5">
                        <div className="flex items-center gap-2">
                          <span className="flex h-6 w-6 items-center justify-center rounded-md bg-blue-100 text-blue-700 shadow-xs">
                            <Tag size={13} />
                          </span>
                          <span className="text-xs font-bold text-slate-800">Descuento al trabajo</span>
                          <span className="rounded-full bg-blue-100/80 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-blue-700">
                            Monto fijo
                          </span>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-12 gap-3 pt-0.5">
                        ...
                        <div className="sm:col-span-5 space-y-1">
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="h-9 w-full rounded-lg border border-slate-200 bg-white pl-7 pr-3 text-xs font-semibold text-slate-800 outline-none transition hover:border-slate-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                            />
                          </div>
                        </div>
                        ...
                        <div className="sm:col-span-7 space-y-1">
                          ...
                          <input
                            type="text"
                            placeholder="Ej: Descuento cliente frecuente, convenio..."
                            value={motivoDescuento}
                            onChange={(e) => setMotivoDescuento(e.target.value)}
                            className="h-9 w-full rounded-lg border border-slate-200 bg-white px-3 text-xs text-slate-800 outline-none transition hover:border-slate-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-100"
                          />
                        </div>
                      </div>
                    </div>
