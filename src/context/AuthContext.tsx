  ...
  const login = async (username: string, password: string) => {
    try {
      ...
      toast.success("¡Bienvenido!", {
        description: `Un gusto tenerte ${response.datos.usuario.persona ? `${response.datos.usuario.persona.nombres || ""} ${response.datos.usuario.persona.apellidos || ""}`.trim() : response.datos.usuario.username}`,
      })
    } catch (err: unknown) {
